...
const Ourpricing = () => {
  ...
  const handleBack = () => setSelectedTitle(null);
  ...
  if (selectedTitle) {
    return (
      <div className="p-6 text-white">
        <button
          onClick={handleBack}
          className="mb-4 text-white underline hover:text-yellow-400">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4 gap-7'>
          {pricingData.map((plan, index) => (
            <div key={index} className='rounded-xl bg-[#131316] py-8 px-5 border border-[#2C2C30]'>
              ...
              <div
                className="flex justify-center items-center py-2.5 w-full rounded-full relative z-0 mt-11 cursor-pointer"
